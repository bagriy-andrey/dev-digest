...
export const agentRuns = pgTable(
  'agent_runs',
  {
    ...
    /** USD cost of this run, as reported by the provider (OpenRouter `usage.cost`)
     *  or estimated from a price table; null when unknown/failed. */
    ...
    /** Multi-agent group this run belongs to, if it was started as part of one. */
