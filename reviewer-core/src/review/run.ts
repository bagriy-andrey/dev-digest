...
export interface ReviewInput {
  ...
  /**
   * Derived PR intent/scope (untrusted — classifier output). Rendered as a
   * trusted scope-policy sentence plus the delimiter-wrapped summary/scope
   * lists. Empty/undefined → section omitted.
   */
